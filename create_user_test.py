...
def negative_assert_symbol(first_name):
    ...
    # Проверяется, что в ответе есть поле code
...
#Тест 7. Ошибка
# Параметр fisrtName состоит из строки с пробелом
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")

#Тест 8. Ошибка
# Параметр fisrtName состоит из строки с символами
...
#Тест 11. Ошибка
# Параметр fisrtName имеет пустове значение
...
#Тест 12. Ошибка
# Параметр fisrtName имеет числовое значение
